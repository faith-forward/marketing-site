...
<Container>
	<div class="min-h-100v flex flex-col py-16 items-center px-4 tablet:px-16 desktop:px-32">
		...
		<div
			class="flex flex-col laptop:flex-row relative top-0 laptop:top-[-64px] laptop:justify-between mt-8 laptop:mt-32 items-center laptop:items-start"
		>
			<img
			...
			<img
				...
				id="testimonial2"
				class="w-3/5 laptop:w-2/5 mt-8 laptop:mt-[124px]"
			/>
		</div>
		<img
			...
			id="testimonial3"
			class="w-3/5 laptop:w-2/5 mt-8 laptop:mt-[-64px]"
		/>
	</div>
</Container>
