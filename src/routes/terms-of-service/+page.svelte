...
<main class="flex flex-col bg-paper flex-1">
	...
	<section
		class="flex laptop:space-x-8 mt-8 flex-col items-center px-4 tablet:px-16 desktop:px-32 flex-1 font-sans"
	>
		<h1 class="mb-4 text-4xl text-boldGrey font-sans-bold">Terms of Service</h1>
		<div class="flex flex-col space-y-6 leading-relaxed px-4 laptop:w-3/5 tablet:w-4/5 w-full">
			<h2 class="text-xl font-sans-semi">Terms & Conditions</h2>
			<p>
				...
				to it, still belong to Faith Forward, Inc.
			</p>
			<p>
				Faith Forward, Inc is committed to ensuring that the app is as useful and efficient as possible. For
			...
			<p>
				The Faith Forward app stores and processes personal data that you have provided to us, to
				...
				programs, compromise your phone’s security features and it could mean that the Faith Forward
				app won’t work properly or at all.
			</p>
			<p>The app does use third-party services that declare their Terms and Conditions.</p>
			<p>
				Link to Terms and Conditions of third-party service providers used by the app: <a
					href="https://expo.dev/terms"
					class="text-blue">Expo</a
				>
			</p>
			<p>
				You should be aware that there are certain things that Faith Forward, Inc will not take
				...
				provider, but Faith Forward, Inc cannot take responsibility for the app not working at full
			...
			<p>
				Along the same lines, Faith Forward, Inc cannot always take responsibility for the way you use the
				app i.e. You need to make sure that your device stays charged – if it runs out of battery
				and you can’t turn it on to avail the Service, Faith Forward, Inc cannot accept responsibility.
			</p>
			<p>
				With respect to Faith Forward, Inc’s responsibility for your use of the app, when you’re using the
				...
				we can make it available to you. Faith Forward, Inc accepts no liability for any loss, direct or
				indirect, you experience as a result of relying wholly on this functionality of the app.
			</p>
			<p>
				At some point, we may wish to update the app. The app is currently available on iOS – the
				...
				to keep using the app. Faith Forward, Inc does not promise that it will always update the app so
				that it is relevant to you and/or works with the iOS version that you have installed on your
				...
				termination, (a) the rights and licenses granted to you in these terms will end; (b) you
				must stop using the app, and (if needed) delete it from your device.
			</p>
			<h2 class="text-xl font-sans-semi mt-24">Changes to This Terms and Conditions</h2>
			<p>
			...
			<p>These terms and conditions are effective as of 2023-01-05</p>
			<h2 class="text-xl font-sans-semi">Contact Us</h2>
			<p>
				If you have any questions or suggestions about our Terms and Conditions, do not hesitate to
				contact us at <a href="mailto:hello@faithforward.app" class="text-blue"
					>hello@faithforward.app</a
				>.
			</p>
			<p>
				This Terms and Conditions page was generated by
				<a href="https://app-privacy-policy-generator.nisrulz.com/" class="text-blue"
