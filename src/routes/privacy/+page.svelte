...
<svelte:head>
	<title>Terms of Service | Personalized Christian Inspiration with Faith Forward</title>
...
<main class="flex flex-col bg-paper flex-1">
	...
	>
		<h1 class="mb-4 text-4xl text-boldGrey font-sans-bold">Privacy Policy</h1>
		<div class="flex flex-col space-y-6 leading-relaxed px-4 laptop:w-3/5 tablet:w-4/5 w-full">
			...
			<p>
				...
				which are accessible at Faith Forward unless otherwise defined in this Privacy Policy.
			</p>
			<h2 class="text-xl font-sans-semi mt-24">Information Collection and Use</h2>
			<p>
				For a better experience, while using our Service, we may require you to provide us with
				certain personally identifiable information, including but not limited to email address. The
			...
			<p>
				Link to the privacy policy of third-party service providers used by the app: <a
					href="https://expo.io/privacy"
					class="text-blue">Expo</a
				>
			</p>

			<h2 class="text-xl font-sans-semi">Log Data</h2>
			<p>
			...
			<h2 class="text-xl font-sans-semi">Cookies</h2>
			<p>
			...
			<h2 class="text-xl font-sans-semi">Service Providers</h2>
			...
			<h2 class="text-xl font-sans-semi">Security</h2>
			<p>
			...
			<h2 class="text-xl font-sans-semi">Links to Other Sites</h2>
			<p>
			...
			<h2 class="text-xl font-sans-semi">Children’s Privacy</h2>
			<p>
			...
			<h2 class="text-xl font-sans-semi">Changes to This Privacy Policy</h2>
			<p>
			...
			<p>This policy is effective as of 2023-01-05</p>
			...
			<p>
				...
				<a href="https://privacypolicytemplate.net" class="text-blue">privacypolicytemplate.net</a>
